...
elliptic.curves = __webpack_require__(14);

// Protocols
elliptic.ec = __webpack_require__(15);
elliptic.eddsa = __webpack_require__(18);
...
curve.base = __webpack_require__(10);
curve.short = __webpack_require__(13);
curve.mont = __webpack_require__(12);
curve.edwards = __webpack_require__(11);
...
function privateToPublic(privateKey) {
  ...
  return new Buffer(secp256k1.keyFromPrivate(privateKey).getPublic(false, 'hex'), 'hex').slice(1);
}
...
var KeyPair = __webpack_require__(16);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(6), __webpack_require__(3).Buffer, __webpack_require__(33)))
